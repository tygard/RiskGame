            ...
            children: <Widget>[
              ...
              new ButtonBar(
                ...
                children: <Widget>[
                  new MaterialButton(
                    onPressed:  () {
                      var package = {'Username': myController.text, 'Faction': "Red"};
                      RiskHttp.makePostRequest("Users", package);
                      Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(title: 'Risk')),);},
                  ...
                  new MaterialButton(
                    onPressed:  () {
                      var package = {'Username': myController.text, 'Faction': "Blue"};
                      RiskHttp.makePostRequest("Users", package);
                      Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(title: 'Risk')),);},
                  ...
                  new MaterialButton(
                    onPressed:  () {
                      var package = {'Username': myController.text, 'Faction': "Green"};
                      RiskHttp.makePostRequest("Users", package);
                      Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(title: 'Risk')),);},
                  ...
                  new MaterialButton(
                    onPressed:  () {
                      var package = {'Username': myController.text, 'Faction': "Yellow"};
                      RiskHttp.makePostRequest("Users", package);
                      Navigator.push(context,MaterialPageRoute(builder: (context) => MyHomePage(title: 'Risk')),);},
